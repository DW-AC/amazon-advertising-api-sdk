...
export declare class SponsoredBrandsCampaignOperation extends Operation {
    ...
    getCampaign(campaignId: CampaignId): Promise<{
        ...
        servingStatus: Readonly<"paused" | "asinNotBuyable" | "billingError" | "ended" | "landingPageNotAvailable" | "outOfBudget" | "pendingReview" | "ready" | "rejected" | "running" | "scheduled" | "terminated" | "portfolioEnded">;
        landingPage: {
