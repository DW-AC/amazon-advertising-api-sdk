...
exports.SponsoredDisplayCampaignUpdateParams = exports.SponsoredDisplayCampaignCreateParams = exports.SponsoredDisplayCampaignExtended = exports.SponsoredDisplayCampaign = exports.ListCampaignsParams = exports.SponsoredBrandsCampaignResponse = exports.CampaignResponse = exports.SponsoredBrandsCampaign = exports.CampaignExtended = exports.CampaignServingStatus = exports.SponsoredBrandsCampaignUpdateParams = exports.SponsoredProductsCampaignUpdateParams = exports.SponsoredBrandsCampaignCreateParams = exports.SponsoredProductsCampaignCreateParams = exports.Campaign = exports.CampaignBidding = exports.CampaignState = exports.CampaignTargetingType = exports.CampaignType = exports.CampaignName = exports.CampaignIds = exports.CampaignId = void 0;
const t = __importStar(require("io-ts"));
const types_1 = require("../commons/types");
const DateFromNumber_1 = require("io-ts-types/lib/DateFromNumber");
const types_2 = require("../portfolios/types");
const campaign_bidding_strategy_1 = require("../bidding/campaign-bidding-strategy");
const campaign_bidding_adjustments_predicate_1 = require("../bidding/campaign-bidding-adjustments-predicate");
/**
 * The ID of the campaign.
 */
exports.CampaignId = t.number;
exports.CampaignIds = t.array(exports.CampaignId);
/**
 * The name of the campaign.
 */
exports.CampaignName = t.string;
/**
 * Specifies the advertising product managed by this campaign.
 */
exports.CampaignType = t.union([t.literal('sponsoredProducts'), t.undefined]);
/**
 * Differentiates between a keyword-targeted and automatically targeted campaign.
 */
exports.CampaignTargetingType = t.union([t.literal('manual'), t.literal('auto')]);
/**
 * Advertiser-specified state of the campaign.
 */
exports.CampaignState = t.union([
    t.literal('enabled'),
    t.literal('paused'),
    t.literal('archived'),
]);
exports.CampaignBidding = t.intersection([
    t.type({
        adjustments: campaign_bidding_adjustments_predicate_1.CampaignBiddingAdjustments,
    }),
    t.partial({
        strategy: campaign_bidding_strategy_1.CampaignBiddingStrategy,
    }),
]);
exports.Campaign = t.intersection([
    t.strict({
        /**
         * The ID of the campaign.
         */
         ...
         * The name of the campaign.
         */
        name: exports.CampaignName,
        /**
         * Specifies the advertising product managed by this campaign.
         */
        campaignType: exports.CampaignType,
        /**
         * Differentiates between a keyword-targeted and automatically targeted campaign.
         */
        targetingType: exports.CampaignTargetingType,
        /**
         * The state of the campaign.
         */
        state: exports.CampaignState,
        /**
    ...
    t.partial({
        ...
        bidding: exports.CampaignBidding,
    }),
]);
exports.SponsoredProductsCampaignCreateParams = t.intersection([
    t.type({
        /**
...
exports.SponsoredBrandsCampaignCreateParams = t.strict({
    /**
     * Campaign name limit is 128 characters.
     * Duplicate campaign names are not allowed. Campaigns with zero positive keywords are not allowed.
     */
...
exports.SponsoredProductsCampaignUpdateParams = t.intersection([
    t.type({
        /**
         * The ID of the campaign.
         */
...
exports.SponsoredBrandsCampaignUpdateParams = t.intersection([
    t.type({
        /**
         * The ID of the campaign.
         */
 ...
 */
exports.CampaignServingStatus = t.union([
    ...
    t.literal('PENDING_START_DATE'),
    t.literal('ENDED'), // The docs don't say about this type
]);
exports.CampaignExtended = t.intersection([
    exports.Campaign,
    t.partial({
        /**
         ...
         * The computed status, accounting for campaign out of budget, policy violations, etc. See developer notes for more information.
         */
        servingStatus: exports.CampaignServingStatus,
    }),
]);
exports.SponsoredBrandsCampaign = t.intersection([
    t.type({
        /**
         * The ID of the campaign.
         */
        campaignId: t.readonly(exports.CampaignId),
        /**
         * Campaign name limit is 128 characters.
         * Duplicate campaign names are not allowed. Campaigns with zero positive keywords are not allowed.
         */
         ...
         */
        servingStatus: t.readonly(t.union([
...
exports.CampaignResponse = t.intersection([
    t.type({
        /**
...
exports.SponsoredBrandsCampaignResponse = t.intersection([
    t.strict({
        /**
         * The idenifier of the campaign.
         */
        campaignId: exports.CampaignId,
        adGroupResponses: t.array(t.intersection([
            t.strict({
                /**
            ...
            types_1.ResponseStatus,
        ])),
        keywordResponses: t.array(t.intersection([
            t.strict({
                /**
...
exports.ListCampaignsParams = t.intersection([
    ...
    t.partial({
         ...
         */
        stateFilter: exports.CampaignState,
        /**
         ...
         */
        campaignIdFilter: exports.CampaignIds,
    }),
]);
// Sponsored Display types
exports.SponsoredDisplayCampaign = t.intersection([
    t.strict({
        /**
         * The ID of the campaign.
         */
...
exports.SponsoredDisplayCampaignExtended = t.intersection([
    exports.SponsoredDisplayCampaign,
    t.partial({
        /**
...
exports.SponsoredDisplayCampaignCreateParams = t.intersection([
    t.type({
        /**
         * Campaign name limit is 128 characters.
         * Duplicate campaign names are not allowed. Campaigns with zero positive keywords are not allowed.
...
exports.SponsoredDisplayCampaignUpdateParams = t.intersection([
    t.type({
        /**
