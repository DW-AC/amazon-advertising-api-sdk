...
import { SnapshotResponse, RequestSnapshotParams, SnapshotId, SponsoredBrandsRecordType, SuccessSnapshotResponse, SnapshotResultType } from './types';
export declare class SponsoredBrandsSnapshotOperation extends Operation {
     ...
     * @returns
     */
    requestSnapshot(recordType: SponsoredBrandsRecordType, params: RequestSnapshotParams): Promise<SnapshotResponse>;
    /**
