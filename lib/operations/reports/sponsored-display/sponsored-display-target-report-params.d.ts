...
export interface SponsoredDisplayTargetReportParams extends SponsoredDisplayBaseReportParams<SponsoredDisplayReportType, SponsoredDisplayTargetReportMetrics> {
    recordType: 'targets';
}
