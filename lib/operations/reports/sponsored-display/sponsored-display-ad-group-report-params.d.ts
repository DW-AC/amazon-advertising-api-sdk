...
export interface SponsoredDisplayAdGroupReportParams extends SponsoredDisplayBaseReportParams<SponsoredDisplayReportType, SponsoredDisplayAdGroupReportMetrics> {
    recordType: 'adGroups';
}
