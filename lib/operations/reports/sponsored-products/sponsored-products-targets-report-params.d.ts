...
export interface SponsoredProductsTargetsReportParams extends BaseReportParams<SponsoredProductsReportType, SponsoredProductsProductTargetingReportMetrics> {
    recordType: 'targets';
}
