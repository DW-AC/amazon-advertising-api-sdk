...
const sponsoredBrandsKeywordRecommendationsOperation = auth_1.amazonAdvertising.sponsoredBrandsKeywordRecommendations;
const sponsoredBrandsKeywordsOperation = auth_1.amazonAdvertising.sponsoredBrandsKeywords;
const sponsoredBrandsNegativeKeywordsOperation = auth_1.amazonAdvertising.sponsoredBrandsNegativeKeywords;
const sponsoredProductsAdGroupKeywordsOperation = auth_1.amazonAdvertising.sponsoredProductsAdGroupKeywords;
const sponsoredProductsAdGroupNegativeKeywordsOperation = auth_1.amazonAdvertising.sponsoredProductsAdGroupNegativeKeywords;
const sponsoredProductsCampaignNegativeKeywordsOperation = auth_1.amazonAdvertising.sponsoredProductsCampaignNegativeKeywords;
const sponsoredProductsSuggestedKeywordsOperation = auth_1.amazonAdvertising.sponsoredProductsSuggestedKeywords;
...
const sponsoredBrandsKeywordRecommendationParams = {
    asins,
};
...
const createSBNegativeKeywordsParams = [
    {
        campaignId: 123,
        adGroupId: 123,
        keywordText: 'Apple',
...
const updateSBNegativeKeywordsParams = [
    {
        campaignId: 123,
        adGroupId: 123,
        keywordId: 123,
...
const createSPNegativeKeywordParams = [
    {
        campaignId: 123,
        adGroupId: 123,
        keywordText: 'Apple',
...
const updateSPNegativeKeywordsParams = [
    {
        keywordId: 123,
        state: 'archived',
    },
...
const createCampaignNegativeKeywordsParams = [
    {
        campaignId: 123,
        keywordText: 'Apple',
        matchType: 'negativeExact',
...
const updateCampaignNegativeKeywordsParams = [
    {
        keywordId: 123,
        state: 'enabled',
    },
...
//# sourceMappingURL=crud-keyword.js.map