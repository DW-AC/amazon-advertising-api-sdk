...
const sponsoredBrandsProductTargetingOperation = auth_1.amazonAdvertising.sponsoredBrandsProductTargeting;
const sponsoredProductsProductTargetingOperation = auth_1.amazonAdvertising.sponsoredProductsProductTargeting;
const BID = 1;
...
const createTargetingClausesParams = [
    {
        campaignId: CAMPAIGN_ID,
        adGroupId: AD_GROUP_ID,
        state: 'paused',
...
const updateTargetingClausesParams = [
    {
        campaignId: CAMPAIGN_ID,
        adGroupId: AD_GROUP_ID,
        targetId: TARGET_ID,
...
//# sourceMappingURL=crud-product-targeting.js.map