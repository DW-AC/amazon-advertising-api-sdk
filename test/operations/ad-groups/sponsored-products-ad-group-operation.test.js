...
describe('SponsoredProductsAdGroupOperation', () => {
    ...
    const adGroupOperation = operationProvider.create(sponsored_products_ad_group_operation_1.SponsoredProductsAdGroupOperation);
    ...
    describe('getAdGroupEx', () => {
        it('should get an extended ad group', async () => {
            ...
            expect(res.servingStatus).toBe('PORTFOLIO_ENDED');
        });
    });
    ...
    describe('listAdGroups', () => {
        it('should return a list of ad groups', async () => {
            ...
            expect(res[0].state).toBe('archived');
        });
    ...
    describe('listAdGroupsEx', () => {
        it('should return an extended list of ad groups', async () => {
            ...
            expect(res[0].servingStatus).toBe('PORTFOLIO_ENDED');
        });
    });
});
//# sourceMappingURL=sponsored-products-ad-group-operation.test.js.map