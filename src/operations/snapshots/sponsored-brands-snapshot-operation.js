...
exports.SponsoredBrandsSnapshotOperation = void 0;
const operation_1 = require("../operation");
const decorators_1 = require("../../decorators");
const amazon_ad_type_uri_prefix_1 = require("../amazon-ad-type-uri-prefix");
const types_1 = require("./types");
class SponsoredBrandsSnapshotOperation extends operation_1.Operation {
    constructor() {
        super(...arguments);
        this.resource = `${this.version}/${amazon_ad_type_uri_prefix_1.AmazonAdTypeURIPrefix.SponsoredBrands}/`;
    }
    /**
...
], SponsoredBrandsSnapshotOperation.prototype, "requestSnapshot", null);
__decorate([
    (0, decorators_1.Decode)(types_1.SnapshotResponse)
], SponsoredBrandsSnapshotOperation.prototype, "getSnapshot", null);
exports.SponsoredBrandsSnapshotOperation = SponsoredBrandsSnapshotOperation;
//# sourceMappingURL=sponsored-brands-snapshot-operation.js.map