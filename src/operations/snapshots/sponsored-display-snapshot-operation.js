...
exports.SponsoredDisplaySnapshotOperation = void 0;
const operation_1 = require("../operation");
const decorators_1 = require("../../decorators");
const amazon_ad_type_uri_prefix_1 = require("../amazon-ad-type-uri-prefix");
const types_1 = require("./types");
class SponsoredDisplaySnapshotOperation extends operation_1.Operation {
    constructor() {
        super(...arguments);
        this.resource = `${amazon_ad_type_uri_prefix_1.AmazonAdTypeURIPrefix.SponsoredDisplay}/`;
    }
    /**
...
], SponsoredDisplaySnapshotOperation.prototype, "requestSnapshot", null);
__decorate([
    (0, decorators_1.Decode)(types_1.SnapshotResponse)
], SponsoredDisplaySnapshotOperation.prototype, "getSnapshot", null);
exports.SponsoredDisplaySnapshotOperation = SponsoredDisplaySnapshotOperation;
//# sourceMappingURL=sponsored-display-snapshot-operation.js.map